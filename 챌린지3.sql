...
-- 속성명 id의 자료형은 INT입니다. 추가로 자동으로 1씩 증가도록 설정하고 기본키로 지정합니다.
-- 속성명 name의 자료형은 VARCHAR(100)입니다.
-- 속성명 position의 자료형은 DECIMAL(10, 2)입니다.
...
-- 이름:가을, 직책:Frontend, 연봉:80000
-- 이름:가을, 직책:Backennd, 연봉:92000
...
-- 4. Frontend 직책을 가진 직원 중에서 연봉이 90000 이하인 직원의 이름과 이름과 연봉을 조회하세요.

SELECT name, salary FROM employees WHERE position = 'Frontend' AND salary <= 90000;na
